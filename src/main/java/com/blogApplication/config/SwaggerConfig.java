...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : 😎", "This Project is developed by Saurabh", "6.4", "Terms of Service", new Contact("Saurabh", "saurabhpawade7@gmail.com", "saurabhpawade7@gmail.com"), "License of APIS", "API License URL",Collections.emptyList());
	}
}
